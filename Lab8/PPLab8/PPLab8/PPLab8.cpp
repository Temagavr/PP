...
void BlurBmpBlock(BlurSettings* settings)
{
...
std::vector<BlurSettings*> CreateBlockSettingsForSingleImage(bitmap_image* inputImagePtr, bitmap_image* outputImagePtr, int blocksQuantity)
{
	std::vector<BlurSettings*> result;
	...
	{
		BlurSettings* s = new BlurSettings();
